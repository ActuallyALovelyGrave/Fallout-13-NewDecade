...
/obj/item/clothing/suit/armor/f13/black_combat_armor
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET
	armor = list(melee = 60, bullet = 60, laser = 25, energy = 15, bomb = 50, bio = 0, rad = 0, fire = 50, acid = 40)
	put_on_delay = 70
	strip_delay = 70
	resistance_flags = FIRE_PROOF
	self_weight = 10
...
/obj/item/clothing/suit/armor/f13/power_armor/tesla
	...
	self_weight = 40
	armor = list(melee = 85, bullet = 70, laser = 80, energy = 80, bomb = 70, bio = 100, rad = 100, fire = 100, acid = 50)
